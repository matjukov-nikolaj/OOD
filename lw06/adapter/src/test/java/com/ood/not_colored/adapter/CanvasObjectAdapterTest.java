...
public class CanvasObjectAdapterTest {

    private ByteArrayOutputStream output = new ByteArrayOutputStream();
    private final PrintStream old = System.out;

    private ModernGraphicsRenderer renderer;
    private CanvasObjectAdapter adapter;

    @Before
    public void setUp() {
        PrintStream printStream = new PrintStream(output);
        System.setOut(printStream);
        this.renderer = new ModernGraphicsRenderer(printStream);
        this.adapter = new CanvasObjectAdapter(this.renderer);
    }
